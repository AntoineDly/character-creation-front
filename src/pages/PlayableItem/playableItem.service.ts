...
import {
  CreatePlayableItemFormInterface,
  PlayableItemDtoInterface,
} from "./playableItem.interface";
...
async function createPlayableItem(
  data: CreatePlayableItemFormInterface,
): Promise<void> {
